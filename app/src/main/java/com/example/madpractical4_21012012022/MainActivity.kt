package com.example.madpractical4_21012012022
...
import com.example.madpractical4_21012012022.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.buttonCall.setOnClickListener {
            Intent(Intent.ACTION_DIAL).setData(Uri.parse("tel:8888888888"))
                .apply { startActivity(this) }
